    ...
    DB.Object({
      ...
      translations: DB.Optional({
        ...
        type: DB.TranslationObject({
          ...
          "No Blessings": null,
          "Restricted Blessings": null,
          "Strongly Restricted Blessings": null,
          "{$nameOfBlessedOnes} cannot use blessings.": null,
          "{$nameOfBlessedOnes} cannot use {$blessings :list type=disjunction}.": null,
          "Favored Skills": null,
          ...
          "{$value} pounds": null,
          ".input {$value :number} {{{$value} lbs}}": null,
          "{$value} lbs": null,
          ...
          "{$apValue} AP to distribute among the following combat techniques: {$list}": null,
          "no AP to distribute among the following combat techniques: {$list}": null,
